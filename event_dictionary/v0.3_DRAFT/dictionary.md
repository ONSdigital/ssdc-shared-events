...
- [2. [Required] Property `Event > payload`](#payload)
  ...
  - [2.11. Property `Event > payload > oneOf > uacUpdate.schema.json`](#payload_oneOf_i10)
    - [2.11.1. Property `Event > payload > oneOf > UAC Update > uacUpdate`](#payload_oneOf_i10_uacUpdate)
      - [2.11.1.1. The following properties are required](#autogenerated_heading_3)
      - [2.11.1.2. Property `Event > payload > oneOf > UAC Update > uacUpdate > caseId`](#payload_oneOf_i10_uacUpdate_caseId)
      - [2.11.1.3. Property `Event > payload > oneOf > UAC Update > uacUpdate > active`](#payload_oneOf_i10_uacUpdate_active)
      - [2.11.1.4. Property `Event > payload > oneOf > UAC Update > uacUpdate > uacHash`](#payload_oneOf_i10_uacUpdate_uacHash)
      - [2.11.1.5. Property `Event > payload > oneOf > UAC Update > uacUpdate > qid`](#payload_oneOf_i10_uacUpdate_qid)
      - [2.11.1.6. Property `Event > payload > oneOf > UAC Update > uacUpdate > receiptReceived`](#payload_oneOf_i10_uacUpdate_receiptReceived)
      - [2.11.1.7. Property `Event > payload > oneOf > UAC Update > uacUpdate > eqLaunched`](#payload_oneOf_i10_uacUpdate_eqLaunched)
...
| - [eqLaunched](#payload_oneOf_i10_uacUpdate_eqLaunched )           | No      | boolean | No         | -          | True if EQ has been launched using this UAC.                 |
|                                                                    |         |         |            |            |                                                              |

##### <a name="autogenerated_heading_3"></a>2.11.1.1. The following properties are required
* surveyLaunched

##### <a name="payload_oneOf_i10_uacUpdate_caseId"></a>2.11.1.2. Property `Event > payload > oneOf > UAC Update > uacUpdate > caseId`
...
##### <a name="payload_oneOf_i10_uacUpdate_active"></a>2.11.1.3. Property `Event > payload > oneOf > UAC Update > uacUpdate > active`
...
##### <a name="payload_oneOf_i10_uacUpdate_uacHash"></a>2.11.1.4. Property `Event > payload > oneOf > UAC Update > uacUpdate > uacHash`
...
##### <a name="payload_oneOf_i10_uacUpdate_qid"></a>2.11.1.5. Property `Event > payload > oneOf > UAC Update > uacUpdate > qid`
...
##### <a name="payload_oneOf_i10_uacUpdate_receiptReceived"></a>2.11.1.6. Property `Event > payload > oneOf > UAC Update > uacUpdate > receiptReceived`
...
##### <a name="payload_oneOf_i10_uacUpdate_eqLaunched"></a>2.11.1.7. Property `Event > payload > oneOf > UAC Update > uacUpdate > eqLaunched`
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2021-09-15 at 11:31:07 +0100