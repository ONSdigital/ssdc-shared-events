...
- [2. [Required] Property `Event > payload`](#payload)
  ...
  - [2.9. Property `Event > payload > oneOf > surveyUpdate.schema.json`](#payload_oneOf_i8)
    - [2.9.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate`](#payload_oneOf_i8_surveyUpdate)
      ...
      - [2.9.1.4. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns)
        - [2.9.1.4.1. Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items](#autogenerated_heading_4)
          - [2.9.1.4.1.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > columnName`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_columnName)
          - [2.9.1.4.1.2. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > metadata`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_metadata)
          - [2.9.1.4.1.3. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules)
            - [2.9.1.4.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > mandatory`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_mandatory)
            - [2.9.1.4.1.3.2. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > type`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_type)
            - [2.9.1.4.1.3.3. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > minLength`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_minLength)
            - [2.9.1.4.1.3.4. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > maxLength`](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_maxLength)
...
| - [sampleSensitiveColumns](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns ) | No      | array of object | No         | -          | -                       |
|                                                                                    |         |                 |            |            |                         |
...
##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns"></a>2.9.1.4. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns`
...
| Each item of this array must be                                      | Description |
| -------------------------------------------------------------------- | ----------- |
| [items](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items) | -           |
|                                                                      |             |

##### <a name="autogenerated_heading_4"></a>2.9.1.4.1. Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items
...
| Property                                                                                | Pattern | Type   | Deprecated | Definition | Title/Description                                         |
| --------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------------------------- |
| + [columnName](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_columnName ) | No      | string | No         | -          | Title of a sensitve (PII) data column in the sample file. |
| + [metadata](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_metadata )     | No      | object | No         | -          | Extra information about this column.                      |
| + [rules](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules )           | No      | object | No         | -          | Rules governing this column.                              |
|                                                                                         |         |        |            |            |                                                           |

##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_columnName"></a>2.9.1.4.1.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > columnName`
...
**Description:** Title of a sensitve (PII) data column in the sample file.
...
##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_metadata"></a>2.9.1.4.1.2. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > metadata`
...
##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules"></a>2.9.1.4.1.3. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules`
...
| Property                                                                                    | Pattern | Type             | Deprecated | Definition | Title/Description                       |
| ------------------------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | --------------------------------------- |
| + [mandatory](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_mandatory ) | No      | boolean          | No         | -          | True if the column is mandatory.        |
| + [type](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_type )           | No      | enum (of string) | No         | -          | Enforced/validated type of column data. |
| - [minLength](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_minLength ) | No      | integer          | No         | -          | Minimum length of column data.          |
| - [maxLength](#payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_maxLength ) | No      | integer          | No         | -          | Maximum length of column data.          |
|                                                                                             |         |                  |            |            |                                         |

##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_mandatory"></a>2.9.1.4.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > mandatory`
...
##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_type"></a>2.9.1.4.1.3.2. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > type`
...
##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_minLength"></a>2.9.1.4.1.3.3. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > minLength`
...
##### <a name="payload_oneOf_i8_surveyUpdate_sampleSensitiveColumns_items_rules_maxLength"></a>2.9.1.4.1.3.4. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleSensitiveColumns > items > rules > maxLength`
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2021-08-18 at 12:27:53 +0100