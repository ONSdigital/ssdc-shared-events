...
- [2. [Required] Property `Event > payload`](#payload)
  ...
  - [2.10. Property `Event > payload > oneOf > surveyUpdate.schema.json`](#payload_oneOf_i9)
    - [2.10.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate`](#payload_oneOf_i9_surveyUpdate)
        ...
        - [2.10.1.5.1. Event > payload > oneOf > Survey Update > surveyUpdate > sampleDefinition > sampleDefinition items](#autogenerated_heading_3)
          ...
          - [2.10.1.5.1.2. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleDefinition > sampleDefinition items > rules`](#payload_oneOf_i9_surveyUpdate_sampleDefinition_items_rules)
            - [2.10.1.5.1.2.1. Event > payload > oneOf > Survey Update > surveyUpdate > sampleDefinition > sampleDefinition items > rules > rules items](#autogenerated_heading_4)
              - [2.10.1.5.1.2.1.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleDefinition > sampleDefinition items > rules > rules items > className`](#payload_oneOf_i9_surveyUpdate_sampleDefinition_items_rules_items_className)
      ...
      - [2.10.1.6. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedPrintFulfilments`](#payload_oneOf_i9_surveyUpdate_allowedPrintFulfilments)
        - [2.10.1.6.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedPrintFulfilments > allowedPrintFulfilments items](#autogenerated_heading_5)
          ...
          - [2.10.1.6.1.3. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedPrintFulfilments > allowedPrintFulfilments items > metadata`](#payload_oneOf_i9_surveyUpdate_allowedPrintFulfilments_items_metadata)
            - [2.10.1.6.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedPrintFulfilments > allowedPrintFulfilments items > metadata > languages`](#payload_oneOf_i9_surveyUpdate_allowedPrintFulfilments_items_metadata_languages)
              - [2.10.1.6.1.3.1.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedPrintFulfilments > allowedPrintFulfilments items > metadata > languages > languages items](#autogenerated_heading_6)
      - [2.10.1.7. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments`](#payload_oneOf_i9_surveyUpdate_allowedSmsFulfilments)
        - [2.10.1.7.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments > allowedSmsFulfilments items](#autogenerated_heading_7)
          ...
          - [2.10.1.7.1.3. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments > allowedSmsFulfilments items > metadata`](#payload_oneOf_i9_surveyUpdate_allowedSmsFulfilments_items_metadata)
            - [2.10.1.7.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments > allowedSmsFulfilments items > metadata > languages`](#payload_oneOf_i9_surveyUpdate_allowedSmsFulfilments_items_metadata_languages)
              - [2.10.1.7.1.3.1.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments > allowedSmsFulfilments items > metadata > languages > languages items](#autogenerated_heading_8)
      - [2.10.1.8. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments`](#payload_oneOf_i9_surveyUpdate_allowedEmailFulfilments)
        - [2.10.1.8.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments > allowedEmailFulfilments items](#autogenerated_heading_9)
          ...
          - [2.10.1.8.1.3. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments > allowedEmailFulfilments items > metadata`](#payload_oneOf_i9_surveyUpdate_allowedEmailFulfilments_items_metadata)
            - [2.10.1.8.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments > allowedEmailFulfilments items > metadata > languages`](#payload_oneOf_i9_surveyUpdate_allowedEmailFulfilments_items_metadata_languages)
              - [2.10.1.8.1.3.1.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments > allowedEmailFulfilments items > metadata > languages > languages items](#autogenerated_heading_10)
  ...
  - [2.12. Property `Event > payload > oneOf > uacUpdate.schema.json`](#payload_oneOf_i11)
    - [2.12.1. Property `Event > payload > oneOf > UAC Update > uacUpdate`](#payload_oneOf_i11_uacUpdate)
      - [2.12.1.1. The following properties are required](#autogenerated_heading_11)
...
##### <a name="payload_oneOf_i6_printFulfilment_personalisation"></a>2.7.1.4. Property `Event > payload > oneOf > Print Fulfilment > printFulfilment > personalisation`
...
##### <a name="payload_oneOf_i9_surveyUpdate_sampleDefinition_items_rules_items_className"></a>2.10.1.5.1.2.1.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > sampleDefinition > sampleDefinition items > rules > rules items > className`
...
| Property                                                                                                              | Pattern | Type            | Deprecated | Definition | Title/Description                |
| --------------------------------------------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | -------------------------------- |
| + [languages](#payload_oneOf_i9_surveyUpdate_allowedPrintFulfilments_items_metadata_languages )                       | No      | array of string | No         | -          | Language(s) of the sent material |
| - [additionalProperties](#payload_oneOf_i9_surveyUpdate_allowedPrintFulfilments_items_metadata_additionalProperties ) | No      | object          | No         | -          | -                                |
|                                                                                                                       |         |                 |            |            |                                  |

##### <a name="payload_oneOf_i9_surveyUpdate_allowedPrintFulfilments_items_metadata_languages"></a>2.10.1.6.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedPrintFulfilments > allowedPrintFulfilments items > metadata > languages`
...
| Each item of this array must be                                                                          | Description |
| -------------------------------------------------------------------------------------------------------- | ----------- |
| [languages items](#payload_oneOf_i9_surveyUpdate_allowedPrintFulfilments_items_metadata_languages_items) | -           |
|                                                                                                          |             |

##### <a name="autogenerated_heading_6"></a>2.10.1.6.1.3.1.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedPrintFulfilments > allowedPrintFulfilments items > metadata > languages > languages items
...
##### <a name="autogenerated_heading_7"></a>2.10.1.7.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments > allowedSmsFulfilments items
...
| Property                                                                                                            | Pattern | Type            | Deprecated | Definition | Title/Description                |
| ------------------------------------------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | -------------------------------- |
| + [languages](#payload_oneOf_i9_surveyUpdate_allowedSmsFulfilments_items_metadata_languages )                       | No      | array of string | No         | -          | Language(s) of the sent material |
| - [additionalProperties](#payload_oneOf_i9_surveyUpdate_allowedSmsFulfilments_items_metadata_additionalProperties ) | No      | object          | No         | -          | -                                |
|                                                                                                                     |         |                 |            |            |                                  |

##### <a name="payload_oneOf_i9_surveyUpdate_allowedSmsFulfilments_items_metadata_languages"></a>2.10.1.7.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments > allowedSmsFulfilments items > metadata > languages`
...
| Each item of this array must be                                                                        | Description |
| ------------------------------------------------------------------------------------------------------ | ----------- |
| [languages items](#payload_oneOf_i9_surveyUpdate_allowedSmsFulfilments_items_metadata_languages_items) | -           |
|                                                                                                        |             |

##### <a name="autogenerated_heading_8"></a>2.10.1.7.1.3.1.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedSmsFulfilments > allowedSmsFulfilments items > metadata > languages > languages items
...
##### <a name="autogenerated_heading_9"></a>2.10.1.8.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments > allowedEmailFulfilments items
...
| Property                                                                                                              | Pattern | Type            | Deprecated | Definition | Title/Description                |
| --------------------------------------------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | -------------------------------- |
| + [languages](#payload_oneOf_i9_surveyUpdate_allowedEmailFulfilments_items_metadata_languages )                       | No      | array of string | No         | -          | Language(s) of the sent material |
| - [additionalProperties](#payload_oneOf_i9_surveyUpdate_allowedEmailFulfilments_items_metadata_additionalProperties ) | No      | object          | No         | -          | -                                |
|                                                                                                                       |         |                 |            |            |                                  |

##### <a name="payload_oneOf_i9_surveyUpdate_allowedEmailFulfilments_items_metadata_languages"></a>2.10.1.8.1.3.1. Property `Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments > allowedEmailFulfilments items > metadata > languages`
...
| Each item of this array must be                                                                          | Description |
| -------------------------------------------------------------------------------------------------------- | ----------- |
| [languages items](#payload_oneOf_i9_surveyUpdate_allowedEmailFulfilments_items_metadata_languages_items) | -           |
|                                                                                                          |             |

##### <a name="autogenerated_heading_10"></a>2.10.1.8.1.3.1.1. Event > payload > oneOf > Survey Update > surveyUpdate > allowedEmailFulfilments > allowedEmailFulfilments items > metadata > languages > languages items
...
##### <a name="autogenerated_heading_11"></a>2.12.1.1. The following properties are required
* surveyLaunched
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2022-02-23 at 08:51:24 +0000