...
##### <a name="autogenerated_heading_5"></a>2.1.1.4.1. Event > payload > oneOf > Case Update > caseUpdate > refusalReceived > items
...
##### <a name="autogenerated_heading_6"></a>2.6.1.2.1. Event > payload > oneOf > Refusal > refusal > type > items
